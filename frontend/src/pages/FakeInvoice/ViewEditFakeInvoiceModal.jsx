...
const ViewEditFakeInvoiceModal = ({ invoice, items, onSave, onClose }) => {
  // Initial item state
  ...
  const [remainingAmount, setRemainingAmount] = useState(invoice.remainingAmount || 0);
  const [brokerCommissionAmount, setBrokerCommissionAmount] = useState(invoice.brokerCommissionAmount || 0);
  ...
  // Add item to invoice
  const handleAddItem = () => {
    if (!currentItem.itemName || !isEditing) {
      return;
    }
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-semibold text-gray-700">
            {isEditing ? 'Edit Invoice' : 'View Invoice'}
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="mb-6">
          ...
          {/* Add Item Form - Only visible when editing */}
          {isEditing && (
...
export default ViewEditFakeInvoiceModal; 