...
import { createBroker } from '../../services/brokerService';

const AddBrokerModal = ({ onClose, onSave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Failed to create broker. Please try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md">
        <div className="flex justify-between items-center p-6 border-b">
          <h2 className="text-xl font-semibold text-gray-800">Add New Broker</h2>
          <button
            onClick={onClose}
